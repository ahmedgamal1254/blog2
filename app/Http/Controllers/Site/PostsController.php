...
class PostsController extends Controller
{
    ...
    public function index(){
        ...
        return view($name.'.index',['post' => $post,'cat' => $cat,
            'latest' => $latest_post,'page' => $pages,'name' => $name]);
    }
    ...
    public function show_page($id){
        ...
        'latest' => $latest_post,'page_single' => $page,'page' => $pages]);
    }
    ...
    public function search(){
        ...
        return view($name.'.search',[
            'cat' => $cat,'latest' => $latest_post,'page' => $pages,'posts' => $posts
        ]);
    }
    ...
    public function contact(){
        ...
        return view($name.'.contact_us',[
            'cat' => $cat,'latest' => $latest_post,'page' => $pages
        ]);
    }
